...
def demo_degradation(peak: float) -> DegradationSpec:
    """The scenario degradation: cylinder 3, early exhaust valve distress."""
...
def sine_jitter(t: float, period: float, amp: float) -> float:
