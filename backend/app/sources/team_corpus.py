...
def corpus_report() -> dict:
    ...
    return {
        ...
        "provenance_note": (
            "Generated by telemetry_generator.py in the team repository. "
            "Gaussian noise around fixed baselines - not sensor data."
        ),
        ...
        "capability_note": (
            "Bulk channels only. Per-cylinder localisation is unavailable on "
            "this corpus: it carries one engine temperature, not four."
        ),
    }
    ...
    def descriptor(self) -> SourceDescriptor:
        ...
        return SourceDescriptor(
            ...
            detail=(
                ...
                "Bulk channels only; no per-cylinder instrumentation."
            ),
            rate_hz=1.0,
        )
