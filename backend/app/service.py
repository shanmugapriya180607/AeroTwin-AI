...
from .mission.profiles import PROFILES, MissionProfile, build_custom_profile, get_profile, sample_profile
...
class AeroTwinService:
    ...
    def start_demo(self) -> dict:
        ...
        self.source = SyntheticFlightSource(
            ...
            flight_id=self.mission.flight_id,
            degradation=DegradationSpec("exhaust_valve_distress", 3, 0.60, 0.95, 0.06, True),
            seed=990001,
        )
        self.source.open()
        self._sim_t = 0.0
